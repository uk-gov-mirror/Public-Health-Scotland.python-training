...
In the exercise below, you have the borders data-set loaded as `borders`. See if you can get the mean value for `LengthOfStay`. Please store the mean value in a variable called `mean_value`, and print that variable. Use the hint button if you need some help.
...
```{python freq-hint-2}
pd.crosstab(borders["HospitalCode"], borders["Sex"]...)
```
...
Besides, if you want to delete the column without having to reassign `df` you can do:
