...
operators_table <- data.frame(
  ...
  "Operator" = c("`**`", "`%`", "`*` `/`", "`//`", "`+` `-`", "`~`", "`&`", "<code>&#124;</code>"), 
  "Description" = c("Power", "Modulus (remainder after division)", "Multiplication, Division", "Floor Division (round down after division)", "Addition, Subtraction", "Logical NOT", "Logical AND", "Logical OR")
)
